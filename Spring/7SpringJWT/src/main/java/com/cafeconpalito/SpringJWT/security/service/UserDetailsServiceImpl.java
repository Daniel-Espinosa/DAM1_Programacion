package com.cafeconpalito.SpringJWT.security.service;

import com.cafeconpalito.SpringJWT.repository.UserRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        com.cafeconpalito.SpringJWT.entity.User user = userRepository.findByUsername(username)
